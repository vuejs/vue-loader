...
module.exports = function (content) {
  ...
  if (script) {
    if (options.esModule) {
      ...
      output +=
        'var __vue_script_exports__ = ' +
        (script.src
          ? getRequireForImport('script', script)
          : getRequire('script', script)) + '\n' +
        'var __vue_script__ = __vue_script_exports__\n'
    }
  ...
  // support named exports in CommonJS mode
  if (!query.inject) {
    // hot reload
    if (needsHotReload) {
      output +=
    ...
    if (!options.esModule) {
      output +=
        'if (__vue_script_exports__) {\n' +
        '  Object.keys(__vue_script_exports__).forEach(function (key) {\n' +
        '    Component.exports[key] = __vue_script_exports__[key]\n' +
        '  })\n' +
        '}\n'
    }
