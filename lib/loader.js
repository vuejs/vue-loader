...
module.exports = function (content) {
  ...
  if (parts.styles.length) {
    ...
    parts.styles.forEach(function (style, i) {
      ...
      var requireString = style.src
        ? getRequireForImport('styles', style, style.attrs ? style.attrs.scoped : style.scoped)
        : getRequire('styles', style, i, style.attrs ? style.attrs.scoped : style.scoped)
  ...
  // scope
  output += '  /* scope */\n  '
  output += (hasScoped ? JSON.stringify({ id: moduleId, scopeUseClass: !!options.scopeUseClass }) : 'null') + ',\n'
