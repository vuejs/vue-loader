...
module.exports = function (content) {
  ...
  var loaderOptionContext = {
    ...
    needCssSourceMap: needCssSourceMap,
    bubleOptions: bubleOptions,
    defaultLoaders: defaultLoaders
  }
  if (options.loaders) {
    Object.keys(options.loaders).forEach(function (lang) {
      if (options.loaders[lang] && typeof options.loaders[lang] === 'function') {
        options.loaders[lang] = options.loaders[lang](loaderOptionContext)
      }
    })
  }
