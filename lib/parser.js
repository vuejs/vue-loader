...
module.exports = function (content, filename, needMap) {
  ...
  fragment.childNodes.forEach(function (node) {
    ...
    var partial = getAttribute(node, 'partial')
    var imported = getAttribute(node, 'imported') != null
    var warnings = null
    var map = null
    ...
    // node count check
    if (
      (type === 'script' || (type === 'template' && !partial)) &&
    ...
    if (src) {
      ...
      } else if (type === 'template' && partial) {
        output.partials.push({
          src: src,
          lang: lang,
          name: partial
        })
    ...
    output[partial ? 'partials' : type].push({
      lang: lang,
      name: partial,
      scoped: scoped,
      imported: imported,
